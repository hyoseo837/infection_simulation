...
class human: 
    ...
    def infect(self):
        ...
        self.sprite = pygame.image.load("C:/Users/효서/Documents/Programming/python/project_covid_simulation/image/infected.png")

    def cure(self):
        self.cured_time = 14
        self.status = "cured"
        self.sprite = pygame.image.load("C:/Users/효서/Documents/Programming/python/project_covid_simulation/image/cured.png")
    
    def die(self):
        self.status = "died"
        self.sprite = pygame.image.load("C:/Users/효서/Documents/Programming/python/project_covid_simulation/image/died.png")
...
for x in range(2,49):
    for y in range(2,49):
        citizen_y.append(human(x * 20, y * 20,"healthy", x-2, y-2))
    citizen.append(citizen_y)
    citizen_y = []

citizen[random.randrange(46)][random.randrange(46)].infect()
